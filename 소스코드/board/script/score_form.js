...
function setBoardInfo() {
    ...
    if (boardObj) {
        ...
        document.getElementById('startDate').value = boardObj.startDate;
        document.getElementById('endDate').value = boardObj.endDate;
...
function saveBoard() {
    ...
    boardParam.startDate = startDate;
    boardParam.endDate=  endDate;
